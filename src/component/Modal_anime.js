...
function ModA({Animes,setAnimes}) {
    ...
    const handleAdd=()=>{
      setAnimes([...Animes,{id:Math.random(),name:newAnimeTitre,image:newAnimeImage,rate:newRate,trailer:newtrailer} ]);
    ...
    return (
      <>
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <input type="text" value={newtrailer} onChange={(e)=>setnewtrailer(e.target.value)}  />
          <Modal.Footer>
