              ...
              <Navbar.Collapse id="navbarScroll">
                ...
                >
                  ...
                  <NavDropdown title="Watching" id="navbarScrollingDropdown">
                    <NavDropdown.Item as={Link} to='/Film' >Film</NavDropdown.Item>
                    <NavDropdown.Item as={Link} to='/Serie'>Serie</NavDropdown.Item>
                    <NavDropdown.Item as={Link} to='/Anime'>Anime</NavDropdown.Item>
                  </NavDropdown>
                </Nav>
